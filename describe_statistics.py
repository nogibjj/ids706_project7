...
def generate_report(stock_stats,sold_stats):
    ...
    # Set font
    pdf.set_font("Times", 'B', 16)  # 'B' indicates bold, and 12 is the font size

    # Adding a cell for Title
    pdf.cell(200, 10, txt = "Descriptive Statistics Report for the Best Sellers of KK's Book Shelf (2023)", ln = True, align = 'C')
    ...
    pdf.cell(200, 10, txt = "Part 1: Data Visualization of the Best Sellers", ln = True, align = 'L')
    ...
    pdf.cell(200, 10, txt = "Part 2: Statistics Analysis of the Best Sellers", ln = True, align = 'L')

    pdf.set_font("Times", '', 10)  

    pdf.cell(200, 10, txt = f"1. Mean of Current Stock: {stock_stats['Mean']}, Mean of the Books Sold: {sold_stats['Mean']}", ln = True, align = 'L')

    pdf.cell(200, 10, txt = f"2. Median of Current Stock: {stock_stats['Median']}, Median of the Books Sold: {sold_stats['Median']}", ln = True, align = 'L')

    pdf.cell(200, 10, txt = f"3. Std of Current Stock: {stock_stats['Standard Deviation']}, Std of the Books Sold: {sold_stats['Standard Deviation']}", ln = True, align = 'L')
